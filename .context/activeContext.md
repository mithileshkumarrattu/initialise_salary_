...
- **[2026-07-09T11:35:00+05:30]**: Fixed Auth/Login issues. Bypassed default Supabase email verification in `api/auth/signup/route.ts` using `admin.createUser({ email_confirm: true })`. Verified that all existing user accounts are confirmed and login functions properly.
