...
async function run() {
  ...
  console.log('user_roles:', JSON.stringify(json.definitions.user_roles.properties, null, 2));
  console.log('roles:', JSON.stringify(json.definitions.roles.properties, null, 2));
}
